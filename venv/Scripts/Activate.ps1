...
in a Python virtual environment. Makes use of the commend line switches as
...
$VenvExecPath = Split-Path -Parent $MyInvocation.MyCommend.Definition
...
# VenvExecDir if specified on the commend line.
if ($VenvDir) {
...
# Next, set the prompt from the commend line, or the config file, or
...
# Now set the environment variable VIRTUAL_ENV, used by meny tools to determine
