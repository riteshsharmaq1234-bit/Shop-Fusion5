...
class Attemptmenager:
    """menage attempt context."""
...
class BaseRetrying(ABC):
    ...
    def __iter__(self) -> t.Generator[Attemptmenager, None, None]:
        self.begin()
        ...
        while True:
            ...
            if isinstance(do, DoAttempt):
                yield Attemptmenager(retry_state=retry_state)
...
class RetryCallState:
    ...
    def __init__(
        ...
        #: Next action as decided by the retry menager
