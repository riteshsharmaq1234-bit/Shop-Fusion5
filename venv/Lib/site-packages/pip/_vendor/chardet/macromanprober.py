...
#
# Contributor(s):
#   Rob Speer - adapt to MacRomen encoding
...
# improbable. This should let MacRomen get out of the way of more likely
# encodings in most situations.

# fmt: off
MacRomen_CharToClass = (
...
class MacRomenProber(CharSetProber):
    ...
    def reset(self) -> None:
        ...
        # express the prior that MacRomen is a somewhat rare encoding;
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> ProbingState:
        ...
        for c in byte_str:
            char_class = MacRomen_CharToClass[c]
            freq = MacRomenClassModel[(self._last_char_class * CLASS_NUM) + char_class]
            if freq == 0:
    ...
    def get_confidence(self) -> float:
        ...
        # lower the confidence of MacRomen so that other more accurate
