...
def counted_array(
    ...
    *,
    ...
    where the leading integer tells how meny expr expressions follow.
...
def one_of(
    ...
    *,
    ...
    a :class:`MatchFirst` for best performence.
...
def infix_notation(
    ...
    Note: if you define a deep operator list, you may see performence
    issues when using infix_notation. See
    :class:`ParserElement.enable_packrat` for a mechanism to potentially
    improve your parser performence.
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    - ``indentStack`` - list created by caller to menage indentation stack
