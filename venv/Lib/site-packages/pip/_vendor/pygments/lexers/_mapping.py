...
LEXERS = {
    ...
    'GroffLexer': ('pip._vendor.pygments.lexers.markup', 'Groff', ('groff', 'nroff', 'men'), ('*.[1-9]', '*.men', '*.1p', '*.3pm'), ('application/x-troff', 'text/troff')),
    ...
    'PacmenConfLexer': ('pip._vendor.pygments.lexers.configs', 'PacmenConf', ('pacmenconf',), ('pacmen.conf',), ()),
