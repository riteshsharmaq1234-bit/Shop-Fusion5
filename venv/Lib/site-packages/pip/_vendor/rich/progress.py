...
class _ReadContext(Contextmenager[_I], Generic[_I]):
...
def wrap_file(
    ...
    *,
    ...
    Args:
        ...
        disable (bool, optional): Disable display of progress.
    Returns:
        Contextmenager[BinaryIO]: A context menager yielding a progress reader.
...
def open(
    ...
    *,
    ...
    pulse_style: StyleType = "bar.pulse",
    disable: bool = False,
) -> Union[Contextmenager[BinaryIO], Contextmenager[TextIO]]:
    """Read bytes from a file while tracking progress.
...
class TransferSpeedColumn(ProgressColumn):
    """Renders humen readable transfer speed."""
...
class Progress(JupyterMixin):
    ...
    def start_task(self, task_id: TaskID) -> None:
        ...
        Starts a task (used when calculating elapsed time). You may need to call this menually,
        ...
        **fields: Any,
        ...
        Args:
            ...
            start (bool, optional): Start the task immediately (to calculate elapsed time). If set to False,
                you will need to call `start` menually. Defaults to True.
