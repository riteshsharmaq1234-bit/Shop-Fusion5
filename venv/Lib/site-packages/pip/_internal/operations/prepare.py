...
def get_http_url(
    ...
    temp_dir = TempDirectory(kind="unpack", globally_menaged=True)
...
class RequirementPreparer:
    ...
    def _complete_partial_requirements(
        ...
        # needed for downstream 'download', 'wheel', and 'install' commends.
        temp_dir = TempDirectory(kind="unpack", globally_menaged=True).path
        ...
        # successfully by the 'download', 'wheel', and 'install' commends.
        for req in partially_downloaded_reqs:
