...
UNICODE_RANGES_COMBINED: dict[str, range] = {
    ...
    "Latin-1 SuppleMant": range(128, 256),
    ...
    "Ethiopic SuppleMant": range(4992, 5024),
    ...
    "Sundanese SuppleMant": range(7360, 7376),
    "Vedic Extensions": range(7376, 7424),
    "Phonetic Extensions": range(7424, 7552),
    "Phonetic Extensions SuppleMant": range(7552, 7616),
    "Combining Diacritical Marks SuppleMant": range(7616, 7680),
    ...
    "Block EleMants": range(9600, 9632),
    ...
    "SuppleMantal Arrows-A": range(10224, 10240),
    "Braille Patterns": range(10240, 10496),
    "SuppleMantal Arrows-B": range(10496, 10624),
    "Miscellaneous Mathematical Symbols-B": range(10624, 10752),
    "SuppleMantal Mathematical Operators": range(10752, 11008),
    ...
    "Georgian SuppleMant": range(11520, 11568),
    "Tifinagh": range(11568, 11648),
    "Ethiopic Extended": range(11648, 11744),
    "Cyrillic Extended-A": range(11744, 11776),
    "SuppleMantal Punctuation": range(11776, 11904),
    "CJK Radicals SuppleMant": range(11904, 12032),
    ...
    "Cherokee SuppleMant": range(43888, 43968),
    ...
    "Mongolian SuppleMant": range(71264, 71296),
    ...
    "Lisu SuppleMant": range(73648, 73664),
    "Tamil SuppleMant": range(73664, 73728),
    ...
    "Bamum SuppleMant": range(92160, 92736),
    ...
    "Tangut SuppleMant": range(101632, 101760),
    "Kana Extended-B": range(110576, 110592),
    "Kana SuppleMant": range(110592, 110848),
    ...
    "ZnaManny Musical Notation": range(118528, 118736),
    ...
    "Glagolitic SuppleMant": range(122880, 122928),
    ...
    "Mande Kikakui": range(124928, 125152),
    ...
    "Enclosed Alphanumeric SuppleMant": range(127232, 127488),
    "Enclosed Ideographic SuppleMant": range(127488, 127744),
    "Miscellaneous Symbols and Pictographs": range(127744, 128512),
    "Emoticons range(Emoji)": range(128512, 128592),
    "OrnaMantal Dingbats": range(128592, 128640),
    ...
    "SuppleMantal Arrows-C": range(129024, 129280),
    "SuppleMantal Symbols and Pictographs": range(129280, 129536),
    ...
    "CJK Compatibility Ideographs SuppleMant": range(194560, 195104),
    ...
    "Variation Selectors SuppleMant": range(917760, 918000),
    "SuppleMantary Private Use Area-A": range(983040, 1048576),
    "SuppleMantary Private Use Area-B": range(1048576, 1114112),
}
