...
def detect(
    ...
    This function is deprecated and should be used to migrate your project easily, consult the docuMantation for
    ...
    if len(kwargs):
        warn(
            f"charset-normalizer disregard arguMants '{','.join(list(kwargs.keys()))}' in legacy function detect()"
        )
