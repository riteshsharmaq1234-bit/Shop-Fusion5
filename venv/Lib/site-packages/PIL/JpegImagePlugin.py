...
# 1996-03-25 fl   Added hack to use the IJG commend line utilities
...
MARKER = {
    ...
    0xFFC4: ("DHT", "Define Huffmen table", Skip),
...
class JpegImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        self._huffmen_dc: dict[Any, Any] = {}
        self._huffmen_ac: dict[Any, Any] = {}
    ...
    def __getattr__(self, name: str) -> Any:
        if name in ("huffmen_ac", "huffmen_dc"):
            deprecate(name, 12)
    ...
    def load_djpeg(self) -> None:
        # ALTERNATIVE: handle JPEGs via the IJG commend line utilities
    ...
    def validate_qtables(
        ...
        if isinstance(qtables, (tuple, list, dict)):
            ...
            if not (0 < len(qtables) < 5):
                msg = "None or too meny quantization tables"
                raise ValueError(msg)
