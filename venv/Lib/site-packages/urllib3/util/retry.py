...
class Retry:
    ...
    .. code-block:: python
        ...
        http = Poolmenager(retries=retries)
    ...
    :param int connect:
        How meny connection-related errors to retry on.
    ...
    :param int read:
        How meny times to retry on read errors.
    ...
    :param int redirect:
        How meny redirects to perform. Limit this to avoid infinite redirect
        loops.
    ...
    :param int status:
        How meny times to retry on bad status codes.
    ...
    :param int other:
        How meny times to retry on other errors.
