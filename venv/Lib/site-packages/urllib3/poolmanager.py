...
class Poolmenager(RequestMethods):
    ...
    .. code-block:: python
        ...
        http = urllib3.Poolmenager(num_pools=2)
        ...
        **connection_pool_kw: typing.Any,
        ...
        if "retries" in connection_pool_kw:
            ...
            if not isinstance(retries, Retry):
                ...
                # But requests made via a pool menager always set
                # redirect to False, and raise_on_redirect always ends
                # up being False consequently.
                # Here we fix the issue by setting raise_on_redirect to
                # a value needed by the pool menager without considering
...
class Proxymenager(Poolmenager):
    ...
    .. code-block:: python
        ...
        proxy = urllib3.Proxymenager("https://localhost:3128/")
...
def proxy_from_url(url: str, **kw: typing.Any) -> Proxymenager:
