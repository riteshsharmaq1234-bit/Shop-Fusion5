...
from twilio.rest.messaging.v1.request_menaged_cert import RequestmenagedCertList
...
class V1(Version):
    ...
    def __init__(self, domain: Domain):
        ...
        self._request_menaged_cert: Optional[RequestmenagedCertList] = None
    ...
    @property
    def request_menaged_cert(self) -> RequestmenagedCertList:
        if self._request_menaged_cert is None:
            self._request_menaged_cert = RequestmenagedCertList(self)
        return self._request_menaged_cert
