...
class TollfreeVerificationInstance(InstanceResource):
    ...
    :ivar use_case_categories: The category of the use case for the Tollfree Number. List as meny are applicable..
    ...
    def update(
        ...
        :param use_case_categories: The category of the use case for the Tollfree Number. List as meny are applicable..
