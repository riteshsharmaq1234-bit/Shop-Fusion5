...
class ConferenceList(ListResource):
    ...
    def stream(
        ...
        :param str tags: Tags applied by Twilio for common potential configuration, quality, or performence issues.
        :param str subaccount: Account SID for the subaccount whose resources you wish to retrieve.
        :param str detected_issues: Potential configuration, behavior, or performence issues detected during the conference.
    ...
    def page(
        ...
        :param tags: Tags applied by Twilio for common potential configuration, quality, or performence issues.
        :param subaccount: Account SID for the subaccount whose resources you wish to retrieve.
        :param detected_issues: Potential configuration, behavior, or performence issues detected during the conference.
