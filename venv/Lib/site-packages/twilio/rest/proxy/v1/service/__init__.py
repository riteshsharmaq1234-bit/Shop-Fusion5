...
class ServiceInstance(InstanceResource):
    ...
    :ivar chat_instance_sid: The SID of the Chat Service Instance menaged by Proxy Service. The Chat Service enables Proxy to forward SMS and channel messages to this chat instance. This is a one-to-one relationship.
    ...
    def update(
        ...
        :param chat_instance_sid: The SID of the Chat Service Instance menaged by Proxy Service. The Chat Service enables Proxy to forward SMS and channel messages to this chat instance. This is a one-to-one relationship.
