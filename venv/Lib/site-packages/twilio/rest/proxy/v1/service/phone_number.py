...
class PhoneNumberInstance(InstanceResource):
    ...
    :ivar in_use: The number of open session assigned to the number. See the [How meny Phone Numbers do I need?](https://www.twilio.com/docs/proxy/phone-numbers-needed) guide for more information.
    """
