...
class NewFactorInstance(InstanceResource):
    ...
    class VerifyPasskeysFactorRequest(object):
        ...
        def __init__(self, payload: Dict[str, Any]):
            ...
            self.type: Optional["NewFactorInstance.str"] = payload.get("type")
            self.response: Optional[
                NewFactorList.VerifyPasskeysFactorRequestResponse
    ...
    :ivar friendly_name: The friendly name of this Factor. This can be any string up to 64 characters, meant for humens to distinguish between Factors.
...
class NewFactorList(ListResource):
    ...
    async def update_async(
        ...
        """
        Asynchronously update the NewFactorInstance
