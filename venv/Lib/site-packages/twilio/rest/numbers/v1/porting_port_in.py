...
class PortingPortInInstance(InstanceResource):
    ...
    class NumbersV1PortingPortInCreatePhoneNumbers(object):
        ...
        :ivar pin: Some losing carriers require a PIN to authorize the port of a phone number. If the phone number is a US mobile phone number, the PIN is mendatory to process a porting request. Other carriers and number types may also require a PIN, you'll need to contact the losing carrier to determine what your phone number's PIN is.
        """
