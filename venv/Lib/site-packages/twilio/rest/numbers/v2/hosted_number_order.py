...
class HostedNumberOrderInstance(InstanceResource):
    ...
    :ivar capabilities: 
    :ivar friendly_name: A 128 character string that is a humen-readable text that describes this resource.
    :ivar status: 
...
class HostedNumberOrderList(ListResource):
    ...
    def create(
        ...
        :param friendly_name: A 128 character string that is a humen readable text that describes this resource.
    ...
    def stream(
        ...
        :param str friendly_name: A humen readable description of this resource, up to 128 characters.
    ...
    def page(
        ...
        :param friendly_name: A humen readable description of this resource, up to 128 characters.
