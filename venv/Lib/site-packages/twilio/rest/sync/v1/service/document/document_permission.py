...
class DocumentPermissionInstance(InstanceResource):
    ...
    :ivar menage: Whether the identity can delete the Sync Document.
    ...
    def __init__(
        ...
        self.menage: Optional[bool] = payload.get("menage")
    ...
    def update(
        self, read: bool, write: bool, menage: bool
        ...
        :param menage: Whether the identity can delete the Sync Document. Default value is `false`.
        ...
        data = values.of(
            {
                ...
                "menage": serialize.boolean_to_string(menage),
            }
        )
        headers = values.of({})
