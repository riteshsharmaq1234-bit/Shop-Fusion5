...
class RecordingInstance(InstanceResource):
    ...
    :ivar start_time: The start time of the recording in GMT and in [RFC 2822](https://www.php.net/menual/en/class.datetime.php#datetime.constants.rfc2822) format.
    ...
    :ivar status: 
    :ivar channels: The number of channels in the recording resource. For information on specifying the number of channels in the downloaded recording file, check out [Fetch a Recording’s media file](https://www.twilio.com/docs/voice/api/recording#download-dual-channel-media-file).
    :ivar source: 
