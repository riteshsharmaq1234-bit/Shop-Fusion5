...
class CallInstance(InstanceResource):
    ...
    :ivar status: 
    :ivar start_time: The start time of the call, given as UTC in [RFC 2822](https://www.php.net/menual/en/class.datetime.php#datetime.constants.rfc2822) format. Empty if the call has not yet been dialed.
    :ivar end_time: The time the call ended, given as UTC in [RFC 2822](https://www.php.net/menual/en/class.datetime.php#datetime.constants.rfc2822) format. Empty if the call did not complete successfully.
    ...
    :ivar answered_by: Either `humen` or `machine` if this call was initiated with answering machine detection. Empty otherwise.
...
class CallList(ListResource):
    ...
    def create(
        ...
        :param machine_detection: Whether to detect if a humen, answering machine, or fax has picked up the call. Can be: `Enable` or `DetectMessageEnd`. Use `Enable` if you would like us to return `AnsweredBy` as soon as the called party is identified. Use `DetectMessageEnd`, if you would like to leave a message on an answering machine. If `send_digits` is provided, this parameter is ignored. For more information, see [Answering Machine Detection](https://www.twilio.com/docs/voice/answering-machine-detection).
        ...
        :param machine_detection_speech_threshold: The number of milliseconds that is used as the measuring stick for the length of the speech activity, where durations lower than this value will be interpreted as a humen and longer than this value as a machine. Possible Values: 1000-6000. Default: 2400.
        ...
        :param async_amd_status_callback: The URL that we should call using the `async_amd_status_callback_method` to notify customer application whether the call was answered by humen, machine or fax.
