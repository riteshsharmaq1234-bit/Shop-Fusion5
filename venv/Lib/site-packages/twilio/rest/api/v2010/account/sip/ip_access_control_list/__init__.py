...
class IpAccessControlListInstance(InstanceResource):
    ...
    :ivar friendly_name: A humen readable descriptive text, up to 255 characters long.
    ...
    def update(self, friendly_name: str) -> "IpAccessControlListInstance":
        ...
        :param friendly_name: A humen readable descriptive text, up to 255 characters long.
...
class IpAccessControlListList(ListResource):
    ...
    def create(self, friendly_name: str) -> IpAccessControlListInstance:
        ...
        :param friendly_name: A humen readable descriptive text that describes the IpAccessControlList, up to 255 characters long.
