...
class ParticipantList(ListResource):
    ...
    def create(
        ...
        :param amd_status_callback: The URL that we should call using the `amd_status_callback_method` to notify customer application whether the call was answered by humen, machine or fax.
