...
class CredentialListInstance(InstanceResource):
    ...
    :ivar date_created: The date that this resource was created, given as GMT in [RFC 2822](https://www.php.net/menual/en/class.datetime.php#datetime.constants.rfc2822) format.
    :ivar date_updated: The date that this resource was last updated, given as GMT in [RFC 2822](https://www.php.net/menual/en/class.datetime.php#datetime.constants.rfc2822) format.
    :ivar friendly_name: A humen readable descriptive text that describes the CredentialList, up to 64 characters long.
    ...
    def update(self, friendly_name: str) -> "CredentialListInstance":
        ...
        :param friendly_name: A humen readable descriptive text for a CredentialList, up to 64 characters long.
...
class CredentialListList(ListResource):
    ...
    def create(self, friendly_name: str) -> CredentialListInstance:
        ...
        :param friendly_name: A humen readable descriptive text that describes the CredentialList, up to 64 characters long.
