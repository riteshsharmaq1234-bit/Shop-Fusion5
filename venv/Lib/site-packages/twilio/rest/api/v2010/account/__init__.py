...
class AccountInstance(InstanceResource):
    ...
    :ivar friendly_name: A humen readable description of this account, up to 64 characters long. By default the FriendlyName is your email address.
    ...
    def update(
        ...
        :param friendly_name: Update the humen-readable description of this Account
        :param status:
...
class AccountList(ListResource):
    ...
    def create(
        ...
        :param friendly_name: A humen readable description of the account to create, defaults to `SubAccount Created at {YYYY-MM-DD HH:MM meridian}`
