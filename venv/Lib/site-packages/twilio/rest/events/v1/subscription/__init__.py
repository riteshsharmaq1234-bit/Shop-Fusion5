...
class SubscriptionInstance(InstanceResource):
    ...
    :ivar description: A humen readable description for the Subscription
    ...
    def update(
        ...
        :param description: A humen readable description for the Subscription.
...
class SubscriptionList(ListResource):
    ...
    def create(
        ...
        :param description: A humen readable description for the Subscription **This value should not contain PII.**
