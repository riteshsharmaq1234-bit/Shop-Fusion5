...
class SinkInstance(InstanceResource):
    ...
    :ivar description: A humen readable description for the Sink
    ...
    def update(self, description: str) -> "SinkInstance":
        ...
        :param description: A humen readable description for the Sink **This value should not contain PII.**
