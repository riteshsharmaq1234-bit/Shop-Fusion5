...
from twilio.rest.preview.wireless.commend import CommendList
...
class Wireless(Version):
    ...
    def __init__(self, domain: Domain):
        ...
        self._commends: Optional[CommendList] = None
        self._rate_plans: Optional[RatePlanList] = None
        self._sims: Optional[SimList] = None

    @property
    def commends(self) -> CommendList:
        if self._commends is None:
            self._commends = CommendList(self)
        return self._commends
