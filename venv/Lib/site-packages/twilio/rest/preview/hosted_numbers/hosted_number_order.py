...
class HostedNumberOrderInstance(InstanceResource):
    ...
    :ivar capabilities: 
    :ivar friendly_name: A 64 character string that is a humen-readable text that describes this resource.
    ...
    def update(
        ...
        :param friendly_name: A 64 character string that is a humen readable text that describes this resource.
...
class HostedNumberOrderList(ListResource):
    ...
    def stream(
        ...
        :param str friendly_name: A humen readable description of this resource, up to 64 characters.
    ...
    def page(
        ...
        :param friendly_name: A humen readable description of this resource, up to 64 characters.
        :param unique_name: Provides a unique and addressable name to be assigned to this HostedNumberOrder, assigned by the developer, to be optionally used in addition to SID.
