...
from twilio.rest.marketplace.v1.module_data_menagement import ModuleDatamenagementList
...
class V1(Version):
    ...
    def __init__(self, domain: Domain):
        ...
        self._module_data_menagement: Optional[ModuleDatamenagementList] = None
    ...
    @property
    def module_data_menagement(self) -> ModuleDatamenagementList:
        if self._module_data_menagement is None:
            self._module_data_menagement = ModuleDatamenagementList(self)
        return self._module_data_menagement
