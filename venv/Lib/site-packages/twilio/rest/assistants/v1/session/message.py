...
class MessageInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], session_id: str):
        ...
        self.content: Optional[Dict[str, object]] = payload.get("content")
...
class MessagePage(Page):
    ...
    def get_instance(self, payload: Dict[str, Any]) -> MessageInstance:
        ...
        return MessageInstance(
            self._version, payload, session_id=self._solution["session_id"]
        )
...
class MessageList(ListResource):
    ...
    def __init__(self, version: Version, session_id: str):
        """
        ...
        self._uri = "/Sessions/{session_id}/Messages".format(**self._solution)
