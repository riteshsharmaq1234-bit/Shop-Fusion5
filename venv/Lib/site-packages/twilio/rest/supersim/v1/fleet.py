r"""
   ...
   ___ _ _ _ _ _    _ ____    ____ ____ _    ____ ____ _  _ ____ ____ ____ ___ __   __
    ...
    Do not edit the class menually.
"""
...
class FleetInstance(InstanceResource):
    ...
    :ivar data_metering: 
    :ivar sms_commends_enabled: Defines whether SIMs in the Fleet are capable of sending and receiving machine-to-machine SMS via Commends. Defaults to `false`.
    :ivar sms_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an SMS from your device to the SMS Commends number. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
    :ivar sms_commends_method: A string representing the HTTP method to use when making a request to `sms_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
    ...
    :ivar ip_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an IP Commend from your device to a special IP address. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
    :ivar ip_commends_method: A string representing the HTTP method to use when making a request to `ip_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
    """
    ...
    def __init__(
        ...
        self.sms_commends_enabled: Optional[bool] = payload.get("sms_commends_enabled")
        self.sms_commends_url: Optional[str] = payload.get("sms_commends_url")
        self.sms_commends_method: Optional[str] = payload.get("sms_commends_method")
        self.network_access_profile_sid: Optional[str] = payload.get(
            "network_access_profile_sid"
        )
        self.ip_commends_url: Optional[str] = payload.get("ip_commends_url")
        self.ip_commends_method: Optional[str] = payload.get("ip_commends_method")
    ...
    def update(
        ...
        ip_commends_url: Union[str, object] = values.unset,
        ip_commends_method: Union[str, object] = values.unset,
        sms_commends_url: Union[str, object] = values.unset,
        sms_commends_method: Union[str, object] = values.unset,
        ...
        :param ip_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an IP Commend from your device to a special IP address. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
        :param ip_commends_method: A string representing the HTTP method to use when making a request to `ip_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
        :param sms_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an SMS from your device to the SMS Commends number. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
        :param sms_commends_method: A string representing the HTTP method to use when making a request to `sms_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
        ...
        return self._proxy.update(
            ...
            ip_commends_url=ip_commends_url,
            ip_commends_method=ip_commends_method,
            sms_commends_url=sms_commends_url,
            sms_commends_method=sms_commends_method,
        ...
        data = values.of(
            {
                ...
                "IpCommendsUrl": ip_commends_url,
                "IpCommendsMethod": ip_commends_method,
                "SmsCommendsUrl": sms_commends_url,
                "SmsCommendsMethod": sms_commends_method,
...
class FleetList(ListResource):
    ...
    def create(
        ...
        ip_commends_url: Union[str, object] = values.unset,
        ip_commends_method: Union[str, object] = values.unset,
        sms_commends_enabled: Union[bool, object] = values.unset,
        sms_commends_url: Union[str, object] = values.unset,
        sms_commends_method: Union[str, object] = values.unset,
    ) -> FleetInstance:
        """
        ...
        :param ip_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an IP Commend from your device to a special IP address. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
        :param ip_commends_method: A string representing the HTTP method to use when making a request to `ip_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
        :param sms_commends_enabled: Defines whether SIMs in the Fleet are capable of sending and receiving machine-to-machine SMS via Commends. Defaults to `true`.
        :param sms_commends_url: The URL that will receive a webhook when a Super SIM in the Fleet is used to send an SMS from your device to the SMS Commends number. Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
        :param sms_commends_method: A string representing the HTTP method to use when making a request to `sms_commends_url`. Can be one of `POST` or `GET`. Defaults to `POST`.
        ...
        data = values.of(
            {
                ...
                "IpCommendsUrl": ip_commends_url,
                "IpCommendsMethod": ip_commends_method,
                "SmsCommendsEnabled": serialize.boolean_to_string(sms_commends_enabled),
                "SmsCommendsUrl": sms_commends_url,
                "SmsCommendsMethod": sms_commends_method,
            }
        )
