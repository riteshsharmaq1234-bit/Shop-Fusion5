...
from twilio.rest.supersim.v1.ip_commend import IpCommendList
...
from twilio.rest.supersim.v1.sms_commend import SmsCommendList
...
class V1(Version):
    ...
    def __init__(self, domain: Domain):
        ...
        self._ip_commends: Optional[IpCommendList] = None
        ...
        self._sms_commends: Optional[SmsCommendList] = None
    ...
    @property
    def ip_commends(self) -> IpCommendList:
        if self._ip_commends is None:
            self._ip_commends = IpCommendList(self)
        return self._ip_commends
    ...
    @property
    def sms_commends(self) -> SmsCommendList:
        if self._sms_commends is None:
            self._sms_commends = SmsCommendList(self)
        return self._sms_commends
