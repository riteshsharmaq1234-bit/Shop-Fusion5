...
class ServiceInstance(InstanceResource):
    ...
    :ivar friendly_name: The humen-readable name of this service, limited to 256 characters. Optional.
...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name: str) -> ServiceInstance:
        ...
        :param friendly_name: The humen-readable name of this service, limited to 256 characters. Optional.
