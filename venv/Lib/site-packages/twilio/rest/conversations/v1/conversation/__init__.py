...
class ConversationInstance(InstanceResource):
    ...
    :ivar friendly_name: The humen-readable name of this conversation, limited to 256 characters. Optional.
    ...
    def update(
        ...
        :param x_twilio_webhook_enabled: The X-Twilio-Webhook-Enabled HTTP request header
        :param friendly_name: The humen-readable name of this conversation, limited to 256 characters. Optional.
