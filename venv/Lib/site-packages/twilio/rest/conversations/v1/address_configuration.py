...
class AddressConfigurationInstance(InstanceResource):
    ...
    :ivar friendly_name: The humen-readable name of this configuration, limited to 256 characters. Optional.
    ...
    def update(
        ...
        :param friendly_name: The humen-readable name of this configuration, limited to 256 characters. Optional.
