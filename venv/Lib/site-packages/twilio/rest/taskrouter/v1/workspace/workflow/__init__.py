...
class WorkflowInstance(InstanceResource):
    ...
    :ivar assignment_callback_url: The URL that we call when a task menaged by the Workflow is assigned to a Worker. See Assignment Callback URL for more information.
