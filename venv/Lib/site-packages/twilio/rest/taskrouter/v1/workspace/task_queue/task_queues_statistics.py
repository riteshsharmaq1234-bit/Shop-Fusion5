...
class TaskQueuesStatisticsList(ListResource):
    ...
    def stream(
        ...
        :param int minutes: Only calculate statistics since this meny minutes in the past. The default is 15 minutes.
    ...
    def page(
        ...
        :param minutes: Only calculate statistics since this meny minutes in the past. The default is 15 minutes.
