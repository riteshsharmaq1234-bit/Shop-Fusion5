...
class EventList(ListResource):
    ...
    def stream(
        ...
        :param int minutes: The period of events to read in minutes. Returns only Events that occurred since this meny minutes in the past. The default is `15` minutes. Task Attributes for Events occuring more 43,200 minutes ago will be redacted.
    ...
    def page(
        ...
        :param minutes: The period of events to read in minutes. Returns only Events that occurred since this meny minutes in the past. The default is `15` minutes. Task Attributes for Events occuring more 43,200 minutes ago will be redacted.
