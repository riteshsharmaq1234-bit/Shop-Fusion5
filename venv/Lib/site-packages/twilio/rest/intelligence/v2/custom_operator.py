...
class CustomOperatorInstance(InstanceResource):
    ...
    def update(
        ...
        :param friendly_name: A humen-readable name of this resource, up to 64 characters.
...
class CustomOperatorList(ListResource):
    ...
    def create(
        ...
        :param friendly_name: A humen readable description of the new Operator, up to 64 characters.
