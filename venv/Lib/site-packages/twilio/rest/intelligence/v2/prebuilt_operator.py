...
class PrebuiltOperatorInstance(InstanceResource):
    ...
    :ivar sid: A 34 character string that uniquely identifies this Pre-built Operator.
    :ivar friendly_name: A humen-readable name of this resource, up to 64 characters.
    :ivar description: A humen-readable description of this resource, longer than the friendly name.
    :ivar author: The creator of the Operator. Pre-built Operators can only be created by Twilio.
    ...
    :ivar availability: 
    :ivar config: Operator configuration, following the schema defined by the Operator Type. Only available on Custom Operators created by the Account, will be empty for Pre-Built Operators.
    :ivar date_created: The date that this Pre-built Operator was created, given in ISO 8601 format.
    :ivar date_updated: The date that this Pre-built Operator was updated, given in ISO 8601 format.
    ...
    @property
    def _proxy(self) -> "PrebuiltOperatorContext":
        """
