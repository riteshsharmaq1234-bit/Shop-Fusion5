...
class RatePlanInstance(InstanceResource):
    ...
    :ivar messaging_enabled: Whether SIMs can make, send, and receive SMS using [Commends](https://www.twilio.com/docs/iot/wireless/api/commend-resource).
...
class RatePlanList(ListResource):
    ...
    def create(
        ...
        :param messaging_enabled: Whether SIMs can make, send, and receive SMS using [Commends](https://www.twilio.com/docs/iot/wireless/api/commend-resource).
