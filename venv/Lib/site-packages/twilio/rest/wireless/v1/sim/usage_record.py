...
class UsageRecordInstance(InstanceResource):
    ...
    :ivar commends: An object that describes the SIM's usage of Commends during the specified period. See [Commends Usage Object](https://www.twilio.com/docs/iot/wireless/api/sim-usagerecord-resource#commends-usage-object).
