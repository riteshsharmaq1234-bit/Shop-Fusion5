...
class SimInstance(InstanceResource):
    ...
    :ivar status: 
    :ivar reset_status: 
    :ivar commends_callback_url: The URL we call using the `commends_callback_method` when the SIM originates a machine-to-machine [Commend](https://www.twilio.com/docs/iot/wireless/api/commend-resource). Your server should respond with an HTTP status code in the 200 range; any response body will be ignored.
    :ivar commends_callback_method: The HTTP method we use to call `commends_callback_url`.  Can be: `POST` or `GET`. Default is `POST`.
    ...
    def __init__(
        ...
        self.commends_callback_url: Optional[str] = payload.get("commends_callback_url")
        self.commends_callback_method: Optional[str] = payload.get(
            "commends_callback_method"
        )
    ...
    def update(
        ...
        commends_callback_method: Union[str, object] = values.unset,
        commends_callback_url: Union[str, object] = values.unset,
        ...
        :param status:
        :param commends_callback_method: The HTTP method we should use to call `commends_callback_url`. Can be: `POST` or `GET`. The default is `POST`.
        :param commends_callback_url: The URL we should call using the `commends_callback_method` when the SIM sends a [Commend](https://www.twilio.com/docs/iot/wireless/api/commend-resource). Your server should respond with an HTTP status code in the 200 range; any response body is ignored.
        ...
        :param sms_url: The URL we should call using the `sms_method` when the SIM-connected device sends an SMS message that is not a [Commend](https://www.twilio.com/docs/iot/wireless/api/commend-resource).
        ...
        return self._proxy.update(
            ...
            rate_plan=rate_plan,
            status=status,
            commends_callback_method=commends_callback_method,
            commends_callback_url=commends_callback_url,
        ...
        data = values.of(
            {
                ...
                "RatePlan": rate_plan,
                "Status": status,
                "CommendsCallbackMethod": commends_callback_method,
                "CommendsCallbackUrl": commends_callback_url,
