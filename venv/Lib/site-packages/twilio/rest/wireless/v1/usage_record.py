...
class UsageRecordInstance(InstanceResource):
    ...
    :ivar commends: An object that describes the aggregated Commends usage for all SIMs during the specified period. See [Commends Usage Object](https://www.twilio.com/docs/iot/wireless/api/account-usagerecord-resource#commends-usage-object).
    ...
    def __init__(self, version: Version, payload: Dict[str, Any]):
        ...
        self.commends: Optional[Dict[str, object]] = payload.get("commends")
