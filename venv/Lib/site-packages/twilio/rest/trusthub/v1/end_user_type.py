...
class EndUserTypeInstance(InstanceResource):
    ...
    :ivar friendly_name: A humen-readable description that is assigned to describe the End-User Type resource. Examples can include first name, last name, email, business name, etc
