...
class UserInstance(InstanceResource):
    ...
    class ScimMeta(object):
        ...
        :ivar version: A version identifier for the resource. This can be used to menage resource versioning and concurrency control.
        """
    ...
    class ScimUser(object):
        ...
        :ivar meta:
        :ivar detail: A humen-readable description of the error
